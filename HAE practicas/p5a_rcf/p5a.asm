...
;p5a.c,18 :: 		void interrupt(){
;p5a.c,19 :: 		key=tecla();
	CALL        _tecla+0, 0
	MOVF        R0, 0 
	MOVWF       _key+0 
;p5a.c,20 :: 		Lcd_Chr_CP(key);
	MOVF        R0, 0 
...
;p5a.c,25 :: 		void main() {
;p5a.c,26 :: 		TRISB=0xF0; //el nibble alto son entradas y el nibble bajo son salidas
	MOVLW       240
	MOVWF       TRISB+0 
;p5a.c,27 :: 		PORTB=0;
	CLRF        PORTB+0 
;p5a.c,29 :: 		INTCON2.RBPU=0; //se habilitan las resistencias de pullup del puerto B
	BCF         INTCON2+0, 7 
;p5a.c,30 :: 		x=PORTB; //para poder borrar el RBIF
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;p5a.c,31 :: 		INTCON.RBIF=0;
	BCF         INTCON+0, 0 
;p5a.c,32 :: 		INTCON.RBIE=1;
	BSF         INTCON+0, 3 
;p5a.c,33 :: 		INTCON.GIE = 1;
	BSF         INTCON+0, 7 
;p5a.c,35 :: 		Lcd_Init();
	CALL        _Lcd_Init+0, 0
;p5a.c,37 :: 		while(1);//{
