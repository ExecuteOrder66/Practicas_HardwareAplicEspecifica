...
;Ej_UNO_Proyecto.c,62 :: 		T0CON.TMR0ON=0;   //Apagamos contador
	BCF         T0CON+0, 7 
;Ej_UNO_Proyecto.c,63 :: 		}
L_interrupt7:
;Ej_UNO_Proyecto.c,64 :: 		if (presencia==0){
	MOVF        _presencia+0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_interrupt8
;Ej_UNO_Proyecto.c,65 :: 		cerrar();
	CALL        _cerrar+0, 0
...
L_interrupt5:
;Ej_UNO_Proyecto.c,71 :: 		if(estado==3){ // estado de puerta cerrandose
	MOVF        _estado+0, 0 
	XORLW       3
	BTFSS       STATUS+0, 2 
	GOTO        L_interrupt9
;Ej_UNO_Proyecto.c,73 :: 		if(cerrada==1){
	MOVF        _cerrada+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_interrupt10
;Ej_UNO_Proyecto.c,74 :: 		parar();
	CALL        _parar+0, 0
;Ej_UNO_Proyecto.c,75 :: 		estado=0;
	CLRF        _estado+0 
;Ej_UNO_Proyecto.c,76 :: 		}
L_interrupt10:
;Ej_UNO_Proyecto.c,83 :: 		}
L_interrupt9:
;Ej_UNO_Proyecto.c,85 :: 		}
L_interrupt0:
;Ej_UNO_Proyecto.c,87 :: 		INTCON.TMR0IF=0; //Deshabilitamos flag interrupcion
	BCF         INTCON+0, 2 
;Ej_UNO_Proyecto.c,88 :: 		}
L_end_interrupt:
L__interrupt17:
	RETFIE      1
; end of _interrupt
...
;Ej_UNO_Proyecto.c,90 :: 		void main() {
;Ej_UNO_Proyecto.c,92 :: 		TRISC.B0=0;
	BCF         TRISC+0, 0 
;Ej_UNO_Proyecto.c,93 :: 		TRISC.B1=0;
	BCF         TRISC+0, 1 
;Ej_UNO_Proyecto.c,94 :: 		TRISB.B0=1;
	BSF         TRISB+0, 0 
;Ej_UNO_Proyecto.c,95 :: 		TRISB.B1=1;
	BSF         TRISB+0, 1 
;Ej_UNO_Proyecto.c,96 :: 		TRISB.B2=1;
	BSF         TRISB+0, 2 
;Ej_UNO_Proyecto.c,97 :: 		PORTC.B0=0;
	BCF         PORTC+0, 0 
;Ej_UNO_Proyecto.c,98 :: 		PORTC.B1=0;
	BCF         PORTC+0, 1 
;Ej_UNO_Proyecto.c,100 :: 		INTCON.TMR0IF=0;
	BCF         INTCON+0, 2 
;Ej_UNO_Proyecto.c,101 :: 		INTCON.TMR0IE=1;
	BSF         INTCON+0, 5 
;Ej_UNO_Proyecto.c,102 :: 		T0CON=0x07; //Prescaler 256, modo 16bits  Se activa al tener la puerta abierta (5s)
	MOVLW       7
	MOVWF       T0CON+0 
;Ej_UNO_Proyecto.c,103 :: 		TMR0H=(26474>>8);    //Alfa para temporizacion 5s
	MOVLW       103
	MOVWF       TMR0H+0 
;Ej_UNO_Proyecto.c,104 :: 		TMR0L=26474;           //Alfa para temporizacion 5s
	MOVLW       106
	MOVWF       TMR0L+0 
;Ej_UNO_Proyecto.c,106 :: 		T1CON=0xA5;
	MOVLW       165
	MOVWF       T1CON+0 
;Ej_UNO_Proyecto.c,107 :: 		TMR1H=(15536>>8);
	MOVLW       60
	MOVWF       TMR1H+0 
;Ej_UNO_Proyecto.c,108 :: 		TMR1L=15536;
	MOVLW       176
	MOVWF       TMR1L+0 
;Ej_UNO_Proyecto.c,109 :: 		PIR1.TMR1IF=0;
	BCF         PIR1+0, 0 
;Ej_UNO_Proyecto.c,110 :: 		PIE1.TMR1IE=1;
	BSF         PIE1+0, 0 
;Ej_UNO_Proyecto.c,111 :: 		INTCON.PEIE=1;
	BSF         INTCON+0, 6 
;Ej_UNO_Proyecto.c,112 :: 		INTCON.GIE=1;
	BSF         INTCON+0, 7 
;Ej_UNO_Proyecto.c,115 :: 		while(1)
L_main11:
;Ej_UNO_Proyecto.c,116 :: 		asm nop;
	NOP
	GOTO        L_main11
;Ej_UNO_Proyecto.c,118 :: 		}
L_end_main:
	GOTO        $+0
; end of _main
